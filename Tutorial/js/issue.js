...
IssueState.prototype = {
    create: function(){
        ...
        Title = game.add.text(20, 20, "Issue a ballot", {font:'30px Arial', fill:'#ffffff'});
        ...
        var style = { font: '20pt Arial', fill: '#EEEEEE', align: 'left', wordWrap: true, wordWrapWidth: 500, wordWrapHeight: 50 };
